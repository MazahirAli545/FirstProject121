      ...
      <KeyboardAwareScrollView
        ...
        <View style={{ marginVertical: 10}}>
         ...
         <TouchableOpacity onPress={console.log("Submited")}>
            <Text style={{fontSize:20, marginLeft:70, paddingLeft: 0, borderRadius: 30, marginVertical: 20, paddingVertical: 10, backgroundColor: "blue", color: "white", borderWidth: 1, marginRight:60, textAlign:"center"}}>Submit</Text>
         </TouchableOpacity>
      </KeyboardAwareScrollView>
